...
class MoveXYZclient(Node):
    ...
    def __init__(self):
        ...
        # Wait for MoveXYZ server to be available
...
def main(args=None):
    ...
    filepath = os.path.join(os.path.expanduser('~'),'projects', 'ros2_sim', 'src', 'ros2_RobotSimulation', 'ros2_execution', 'programs', PR_NAME + ".txt")
